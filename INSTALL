...
----
Installing this Journaling image (GitHub images) project by @seanpm2001
----
...
If you want to load the project language file, you will need to have Ruby installed (version 2.0 or higher)
...
----
Install instructions file version: 2 (2022, Thursday, May 19th at 4:44 pm PST)
----
